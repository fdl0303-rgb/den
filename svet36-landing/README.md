...
- `app/public/hero.jpg` — фотореалистичная заставка главного экрана. Сейчас: «Modern lounge interior»,
  автор Shixart1985, Wikimedia Commons, лицензия CC BY 2.0 (копирайт указан в футере сайта).
